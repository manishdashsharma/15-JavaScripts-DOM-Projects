...
const goblin = document.querySelector('.clash-card__unit-stats.clash-card__unit-stats--goblin.clearfix');
goblin.style.backgroundColor = 'green';

const archer = document.querySelector('.clash-card__unit-stats.clash-card__unit-stats--archer.clearfix');
archer.style.backgroundColor = 'red';

const giant = document.querySelector('.clash-card__unit-stats.clash-card__unit-stats--giant.clearfix');
giant.style.backgroundColor = 'blue';
